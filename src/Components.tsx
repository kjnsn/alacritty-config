...
export function Toggle({
  ...
  const checkColors =
    "peer-focus:ring-[#b7bdf8] dark:peer-focus:ring-[#b7bdf8] ";
    ...
    <label className="inline-flex items-center cursor-pointer mx-3">
      ...
      <div
        className={
          ...
          " after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-[#8aadf4]"
        }
      ></div>
    </label>
  );
